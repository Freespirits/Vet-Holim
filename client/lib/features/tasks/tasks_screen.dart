...
class TasksScreen extends StatelessWidget {
  ...
  List<TaskBoardItem> _mockTasks(AppLocalizations localizations) {
    return [
      TaskBoardItem(
        title: 'Buprenorphine pain control',
        patient: 'מיצי',
        assignee: 'RN Dana',
        dueLabel: '10:00',
      ...
      TaskBoardItem(
        title: 'IV fluids — Lactated Ringer\'s 100 mL',
        patient: 'מיצי',
        assignee: 'RN Dana',
        dueLabel: '10:30',
      ...
      TaskBoardItem(
        title: 'CBC + chemistry panel',
        patient: 'לוקה',
        assignee: 'Lab Tech Maya',
        dueLabel: '12:30',
        priority: TaskPriority.routine,
      ...
      TaskBoardItem(
        title: 'Discharge briefing with owner',
        patient: 'לוקה',
        assignee: 'RN Dana',
        dueLabel: '13:15',
        priority: TaskPriority.routine,
